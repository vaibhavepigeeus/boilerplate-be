"""
Django settings for boilerplate backend project.
"""
...
SECRET_KEY = config("SECRET_KEY", default="django-insecure-boilerplate-dev-key-change-in-production")
...
MIDDLEWARE = [
    ...
    "boilerplate.custom_middleware_validation.NotFoundMiddleware",
    "boilerplate.token_verification_middleware.TokenVerificationMiddleware",
    "boilerplate.custom_middleware_validation.SpecialCharacterMiddleware",
    "boilerplate.custom_middleware_validation.DecodeURLEncodedMiddleware",
    "boilerplate.custom_middleware_validation.CustomMiddleware",
]
...
DATABASES = {
    "default": {
        ...
        "NAME": config("DATABASE_NAME", default="boilerplate_db"),
